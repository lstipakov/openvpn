...
/**
 * @brief Load the tls-auth/tls-crypt(-v2) key material into c->c1.ks.
 *
 * Reads the key from the file configured on connection entry ce (--tls-auth,
 ...
 *
 * Sets tls_wrap to TLS_WRAP_AUTH (--tls-auth) or TLS_WRAP_CRYPT
