 ...
 *
 * The whole sequence is walked, including the part after the wanted type: a TLV
 * we do not understand and that is not marked optional invalidates the message
 * wherever it sits, and rejecting it is the point of the remaining scan.
 *
